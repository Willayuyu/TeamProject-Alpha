...
import com.example.fidledemo.moudle10.service.PersonalCarServiceImpl;
...
public class PersonalCardController {
    @Autowired
    PersonalCarServiceImpl personalCarService;
    ...
    public String getGoodsEvaluation(HttpServletRequest request){
        ...
        List<GoodsEvaluationVO> list = personalCarService.getGoodsEvaluationByLike(id,isLike,pageid);
    ...
    public String getTaskEvaluation(HttpServletRequest request){
        ...
        Integer pageid = Integer.valueOf(request.getParameter("pageId"));
        List<TaskEvaluationVO> list = personalCarService.getTaskEvaluationByLike(id,isLike,pageid);
        return JSON.toJSONString(Result.successResult(list));
    }
}
